...
class Waitalk(smach.State):
      ...
      def execute(self,userdata):
         # self.pass_call = "No"
          try:
            talk_data.sentence = "When the hand is pushed, I will make a container"
            talk_pub.publish(talk_data)

            print wrench
            print wrench[0][0] # force x
            print wrench[0][1] # force y
            print wrench[0][2] # force z
            print wrench[1][0] # torque x
            print wrench[1][1] # torque y
            print wrench[1][2] # torque z
